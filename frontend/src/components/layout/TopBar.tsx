...
export const TopBar = ({ sidebarWidth }: { sidebarWidth: number }) => {
  return (
    <header className="fixed top-0 right-0 z-20 px-6 py-4 transition-[left] duration-150" style={{ left: sidebarWidth }}>
